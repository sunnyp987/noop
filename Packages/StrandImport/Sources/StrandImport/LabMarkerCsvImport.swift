...
public enum LabMarkerCsvImport {
    ...
    private static let aliasTable: [String: String] = {
        ...
        let extras: [String: String] = [
            ...
            "folic_acid": "folate",
            "serum_iron": "iron", "iron_total": "iron",
            "tsat": "transferrin_saturation", "saturation": "transferrin_saturation",
            "iron_binding_capacity": "tibc", "total_iron_binding_capacity": "tibc",
            ...
            // Extended lipids / metabolic / kidney / liver / electrolytes / CBC / thyroid / hormones
            // (Superpower/Quest-style full-panel reports) — common alternate report spellings.
            "apo_b": "apob", "apolipoprotein_b": "apob",
            "apo_a1": "apoa1", "apolipoprotein_a1": "apoa1", "apolipoprotein_a_1": "apoa1",
            "lp_a": "lp_a", "lipoprotein_a": "lp_a", "lipoprotein_little_a": "lp_a",
            "non_hdl": "non_hdl_cholesterol", "non_hdl_c": "non_hdl_cholesterol",
            "tc_hdl_ratio": "cholesterol_hdl_ratio", "total_cholesterol_hdl_ratio": "cholesterol_hdl_ratio",
            "cholesterol_hdl_ratio": "cholesterol_hdl_ratio", "chol_hdlc_ratio": "cholesterol_hdl_ratio",
            "homa_ir": "homa_ir", "homeostatic_model_assessment": "homa_ir",
            "uric_acid": "uric_acid", "urate": "uric_acid",
            "blood_urea_nitrogen": "bun", "urea_nitrogen": "bun", "urea_nitrogen_bun": "bun",
            "bun_creatinine_ratio": "bun_creatinine_ratio", "urea_to_creatinine_ratio": "bun_creatinine_ratio",
            "cystatin_c": "cystatin_c",
            "bilirubin_total": "total_bilirubin", "total_bilirubin": "total_bilirubin",
            "bilirubin_direct": "direct_bilirubin", "bilirubin_indirect": "indirect_bilirubin",
            "protein_total": "total_protein", "total_protein": "total_protein",
            "globulin_total": "globulin",
            "albumin_globulin_ratio": "ag_ratio", "a_g_ratio": "ag_ratio",
            "co2": "co2", "carbon_dioxide_total": "co2", "carbon_dioxide": "co2", "bicarbonate": "co2",
            "rbc": "rbc_count", "red_blood_cell_count": "rbc_count", "red_blood_cells": "rbc_count",
            "hct": "hematocrit",
            "platelets": "platelet_count", "plt": "platelet_count",
            "mean_platelet_volume": "mpv",
            "neutrophils": "neutrophil_pct", "neutrophil_percent": "neutrophil_pct",
            "monocytes": "monocyte_pct", "monocyte_percent": "monocyte_pct",
            "eosinophils": "eosinophil_pct", "eosinophil_percent": "eosinophil_pct",
            "basophils": "basophil_pct", "basophil_percent": "basophil_pct",
            "neutrophils_absolute": "neutrophil_absolute", "neutrophil_absolute": "neutrophil_absolute", "neut_absolute": "neutrophil_absolute",
            "absolute_neutrophils": "neutrophil_absolute", "absolute_neutrophil_count": "neutrophil_absolute",
            "lymphocytes_absolute": "lymphocyte_absolute", "lymphs_absolute": "lymphocyte_absolute",
            "absolute_lymphocytes": "lymphocyte_absolute", "absolute_lymphocyte_count": "lymphocyte_absolute",
            "monocytes_absolute": "monocyte_absolute", "mono_absolute": "monocyte_absolute",
            "absolute_monocytes": "monocyte_absolute", "absolute_monocyte_count": "monocyte_absolute",
            "eosinophils_absolute": "eosinophil_absolute", "eos_absolute": "eosinophil_absolute",
            "absolute_eosinophils": "eosinophil_absolute", "absolute_eosinophil_count": "eosinophil_absolute",
            "basophils_absolute": "basophil_absolute", "baso_absolute": "basophil_absolute",
            "absolute_basophils": "basophil_absolute", "absolute_basophil_count": "basophil_absolute",
            "triiodothyronine_free": "free_t3", "t3_free": "free_t3",
            "triiodothyronine_total": "total_t3", "t3_total": "total_t3",
            "thyroxine_total": "total_t4", "t4_total": "total_t4", "t4_thyroxine_total": "total_t4",
            "tpo_ab": "tpo_antibodies", "thyroid_peroxidase_antibodies": "tpo_antibodies", "thyroid_peroxidase_ab": "tpo_antibodies",
            "thyroglobulin_ab": "thyroglobulin_antibodies",
            "total_testosterone": "testosterone_total", "testosterone": "testosterone_total",
            "testosterone_total_ms": "testosterone_total",
            "free_testosterone": "testosterone_free",
            "bioavailable_testosterone": "testosterone_bioavailable",
            "free_t4_index_t7": "free_t4_index", "fti": "free_t4_index",
            "dhea_sulfate": "dhea_s", "dheas": "dhea_s",
            "cortisol_total": "cortisol",
            "vitamin_d_25_oh_total_ia": "vitamin_d",
            "luteinizing_hormone": "lh",
            "follicle_stimulating_hormone": "fsh",
            "insulin_like_growth_factor_1": "igf_1", "igf1": "igf_1",
            "prostate_specific_antigen": "psa",
            "sed_rate": "esr", "erythrocyte_sedimentation_rate": "esr",
            "rbc_folate": "rbc_folate", "folate_rbc": "rbc_folate",
            "mma": "methylmalonic_acid",
            "vit_b6": "vitamin_b6", "pyridoxal_5_phosphate": "vitamin_b6",
            "calcium_corrected": "corrected_calcium", "albumin_adjusted_calcium": "corrected_calcium",
            "ox_ldl": "oxidized_ldl",
            "iga": "immunoglobulin_a", "ige": "immunoglobulin_e",
            "ana": "ana_titer", "antinuclear_antibodies": "ana_titer",
            "rf": "rheumatoid_factor", "rheumatoid_arthritis_factor": "rheumatoid_factor",
            "ccp_ab": "ccp_antibody", "cyclic_citrullinated_peptide_antibody": "ccp_antibody",
            "dsdna_ab": "dsdna_antibody", "double_stranded_dna_antibodies": "dsdna_antibody",
            "ttg_ab": "ttg_antibody", "tissue_transglutaminase_ab": "ttg_antibody", "tissue_transglutaminase_antibody": "ttg_antibody",
            "ldl_hdl_ratio": "ldl_hdl_ratio",
            "triglyceride_hdl_molar_ratio": "triglyceride_hdl_ratio", "tg_hdl_ratio": "triglyceride_hdl_ratio",
            "nlr": "neutrophil_lymphocyte_ratio", "neutrophil_to_lymphocyte_ratio": "neutrophil_lymphocyte_ratio",
            "plr": "platelet_lymphocyte_ratio", "platelet_to_lymphocyte_ratio": "platelet_lymphocyte_ratio",
            "mlr": "monocyte_lymphocyte_ratio", "monocyte_to_lymphocyte_ratio": "monocyte_lymphocyte_ratio",
            "aip": "atherogenic_index_plasma", "atherogenic_index_of_plasma": "atherogenic_index_plasma",
        ]
