...
struct MarkMomentIntent: AppIntent {
    ...
    static var description = IntentDescription("Record a timestamped moment in Baseline.")
...
/// Surfaces Baseline's intents to Siri, Spotlight, and the Shortcuts gallery without any user setup.
