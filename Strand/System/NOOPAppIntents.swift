...
/// `weak` shared accessor lets an intent fired while Baseline is closed fail with a clear "open Baseline"
...
enum NOOPIntentError: Error, CustomLocalizedStringResourceConvertible {
    ...
    var localizedStringResource: LocalizedStringResource {
        switch self {
        case .notRunning:   return "Open Baseline first so it can reach your strap."
        case .notConnected: return "Connect your WHOOP strap in Baseline, then try again."
        }
    }
}
