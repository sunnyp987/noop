...
struct AutomationsView: View {
    ...
    private var wristAlertsCard: some View {
        Section2(icon: "bell.badge.fill", title: String(localized: "Wrist alerts"),
                 blurb: String(localized: "Let Baseline tap your wrist for the things you turn on below, so you can leave your phone and still feel what matters."),
        ...
        Section2(icon: "bolt.heart.fill", title: String(localized: "Haptic coaching"),
            ...
            VStack(spacing: 0) {
                ...
                ToggleRow(label: String(localized: "Stress check-ins (haptic)"),
                          help: String(localized: "When a fresh, non-exercise HRV dip is detected while you're still, Baseline offers a one-minute guided breath: a single confirming buzz and a dismissible card. Never an alarm, never a diagnosis."),
