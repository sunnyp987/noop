...
public enum RhythmConsent {
    ...
    public static let points: [(String, String)] = [
        ...
        (String(localized: "It is not a substitute for a professional"),
         String(localized: "If you feel unwell or are worried about your heart, contact a qualified professional; in an emergency, your local emergency service. Do not rely on Baseline.")),
    ...
    private var methodologyCard: some View {
        StrandCard {
            VStack(alignment: .leading, spacing: 8) {
                ...
                Text("During quiet, still, resting windows, Baseline looks at the timing between your heartbeats (R-R intervals) and draws their Poincaré scatter. From the cloud it computes its short and long axes (SD1, SD2) and a few plain regularity numbers. Movement and noisy windows are skipped, not shown. These are transparent, published descriptive statistics: a picture of your timing, never a clinical measurement.")
                    .font(StrandFont.footnote)
                    .foregroundStyle(StrandPalette.textTertiary)
                    .fixedSize(horizontal: false, vertical: true)
            }
