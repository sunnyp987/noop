...
struct StorageView: View {
    ...
    var body: some View {
        ScreenScaffold(title: "Storage",
                       subtitle: "Where Baseline's on-device space is going, and a one-tap clean-up.") {
        ...
        return StrandCard {
            VStack(alignment: .leading, spacing: NoopMetrics.cardInnerSpacing) {
                ...
                Text(reclaimable > 0
                     ...
                     : "Nothing to reclaim right now. Baseline already cleans up import scratch space automatically.")
    ...
    private var explainerCard: some View {
        DataPendingNote(
            ...
            message: "When you import an Apple Health or WHOOP export, iOS hands Baseline a private copy of the file. Baseline reads it, saves your data into the health database, then deletes the copy. Older builds didn't delete every copy. This screen reclaims any that were left behind.",
